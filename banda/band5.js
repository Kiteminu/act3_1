...
function Calcular(b1,b2,b3,b4,b5){ //se llama a los cuatro valores de los cuatro input, se necesitaran para el calculo

  var valResistencia=(b2*b4)+(b3*(b4/10))+(b1*b4); //Calculo del valor de la resistencia, solo se usa b1, b2, b3 y b4
